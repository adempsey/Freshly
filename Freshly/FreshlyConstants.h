...
#define FRESHLY_CATEGORY_PROTEIN	@"Protein"
...
#define FRESHLY_COLOR_PRIMARY UIColorFromRGB(0xF6F5EE)
#define FRESHLY_COLOR_SECONDARY UIColorFromRGB(0xE6E5DD)
#define FRESHLY_COLOR_LIGHT UIColorFromRGB(0xFFFFFF)
#define FRESHLY_COLOR_DARK UIColorFromRGB(0x4F4F4F)
#define FRESHLY_COLOR_SELECTED UIColorFromRGB(0x29A653)
#define FRESHLY_COLOR_SELECTED_LIGHT UIColorFromRGB(0xD6E7D6)
#define FRESHLY_COLOR_RED UIColorFromRGB(0xFF7258)
...
#define FRESHLY_CATEGORY_COLOR_PROTEIN UIColorFromRGB(0xF1813B)
...
#define NOTIFICATION_CUSTOM_USER_FOOD_SOURCES_UPDATED @"notificationCustomUserFoodSourcesUpdated"
